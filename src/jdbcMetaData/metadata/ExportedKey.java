...
public class ExportedKey {
    ...
    public static List<ExportedKey> of(ResultSet rows) throws SQLException {
        ...
        while (rows.next()) {
            ...
            ExportedKey exportedKey = new ExportedKey(pktableName, pkcolumnName, fktableName, fkcolumnName);
